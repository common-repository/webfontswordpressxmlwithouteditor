...
if(is_dir(WP_PLUGIN_DIR.'/webfontswordpressxmlwithouteditor'))
	{ 
	define("FOLDER_NAME","webfontswordpressxmlwithouteditor");
	}
else if(is_dir(WP_PLUGIN_DIR.'/WebfontsWordpressXmlWithoutEditor'))
	{
	define("FOLDER_NAME","WebfontsWordpressXmlWithoutEditor");
	}
//define("FOLDER_NAME","WebfontsWordpressXmlWithoutEditor");
